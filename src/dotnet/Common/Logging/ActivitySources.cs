...
namespace FoundationaLLM.Common.Logging
{
    ...
    {
        /// <summary>
        /// AuthorizationAPI ActivitySource.
        /// </summary>
        public static readonly ActivitySource AuthorizationAPI = new(ServiceNames.AuthorizationAPI);
        ...
        /// <summary>
        /// GatewayAPI ActivitySource.
        /// </summary>
        public static readonly ActivitySource GatewayAPIActivitySource = new(ServiceNames.GatewayAPI);
