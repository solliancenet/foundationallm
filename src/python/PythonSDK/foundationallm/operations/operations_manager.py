...
class OperationsManager():
    ...
    def __init__(self, config: Configuration):
        ...
        self.verify_certs = False if env == 'dev' or 'localhost' in self.state_api_url  else True
    ...
    async def create_operation(
        ...
        try:
            ...
            jData = r.json()
            logger.info(f"create_operation : {operation_id} : {jData}")
            return jData
    ...
    async def update_operation(self,
        ...
        try:
            ...
            jData = r.json()
            logger.info(f"update_operation : {operation_id} : {jData}")
            return jData
        except Exception as e:
            raise e
    ...
    async def get_operation(
        ...
        try:
            ...
            logger.info(f'status endpoint: {self.state_api_url}/instances/{instance_id}/operations/{operation_id}')
            ...
            jData = r.json()
            logger.info(f"get_operation : {operation_id} : {jData}")
            return jData
        except Exception as e:
            raise e
    ...
    async def set_operation_result(
        ...
        try:
            ...
            logger.info(f"set_operation_result : {operation_id}")
