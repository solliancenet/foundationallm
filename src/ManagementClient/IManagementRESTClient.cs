...
namespace FoundationaLLM.Client.Management
{
    public interface IManagementRESTClient
    {
        ...
        /// <returns></returns>
        Task<List<T>> GetResources<T>(string instanceId, string resourceProvider, string resourcePath);
        /// <summary>
        /// Upserts a resource
        /// </summary>
        /// <typeparam name="T">The resource type</typeparam>
        ...
        Task<T> UpsertResource<T>(T resource, string instanceId, string resourceProvider, string resourcePath);
        /// <summary>
        ...
        /// <returns></returns>
        Task DeleteResource(string instanceId, string resourceProvider, string resourcePath);
    }
}
